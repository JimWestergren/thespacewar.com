...
function commanderData() : array
{
    return [
        ...
        'nicia-satu' => [
            ...
            'rules' => 'Spend 1 action: Put a counter on this commander.<br>Action phase: Remove any number of counters. Gain that many actions.',
        ...
        'capt-shera-kinson' => [
            ...
            'rules' => 'Spend 10 actions: Search your draw pile for the Starship and put it into play.',
            'lore' => 'Capt. Shera Kinson is known throughout United Stars for relentless preparation. While others debate timing and risk, she ensures that the Starship is always ready to launch. When her deploy command is given, there is zero delay.',
            'changelog' => [
        ...
        'capt-wayne-mccarter' => [
            ...
            'rules' => 'Your Starship is not slow.<br>When your Starship attacks, it makes an additional 1-damage attack after the normal attack.',
