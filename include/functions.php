...
function commanderData() : array
{
    return [
        ...
        'frank-johnson' => [
            ...
            'changelog' => [
                'Buff in August 2026: Life increased from 3 to 4.',
        ...
        'keve-bakins' => [
            ...
            'changelog' => [
                'Buff in August 2026: Life increased from 4 to 5.',
        ...
        'dr-stein' => [
            ...
            'rules' => 'Spend 1 action, discard a card and take 2 station damage: Search your draw pile for a card, shuffle, then put it on top.',
            ...
            'changelog' => [
                'Nerf in August 2026: Ability now costs 1 action and it also requires to discard a card. Life also reduced from 2 to 1.',
        ...
        'the-miller' => [
            ...
            'name' => 'The Miller',
            'title' => 'Sentient AI',
            'rules' => 'At any time instead of drawing a card, you may force the opponent to discard the top 3 cards from their draw pile.',
            ...
            'changelog' => [
                'Buff in August 2026: Ability now mills 3 cards instead of 2. Life decreased from 6 to 5.',
                'June 2019: Created.',
            ],
        ],
        'zuuls' => [
        ...
        'naalox' => [
            ...
            'name' => 'Naalox',
            'title' => 'Regeneration',
            'rules' => 'Spend 2 actions: Put a Drone from your discard pile into play and/or repair 1 station damage.',
            ...
            'changelog' => [
                'Buff in August 2026: Ability can now be used unlimited amount of times per turn and "or" has been replaced with "and/or".',
                'July 2020: Created.',
            ],
        ],
        'staux' => [
        ...
        'capt-shera-kinson' => [
            ...
            'rules' => 'Spend 8 actions:<br>Search your draw pile or station cards for the Starship and put it into play.',
            ...
            'changelog' => [
                'Buff in August 2026: Ability now cost 8 actions and not 10.',
