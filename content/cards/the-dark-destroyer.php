<?php
$title_tag = 'The Dark Destroyer | TheSpaceWar.com';
require(ROOT.'view/head.php');
?>

<h1>The Dark Destroyer</h1>
...
<p>All those 5 cards are really bad against The Dark Destroyer, especially the first 2 which completely destroys it.</p>
