...
<?php if ($logged_in != []) { ?>
    <p><a href='/account/' class='big-button'>Your account</a></p>
<?php } else { ?>
...
<p>The game has to be fully tested and finalized first before the printing can be done. Once the printing is done you will be able to order the game on Amazon.</p>

<h2>Print & Play</h2>
<p>You can print and play the game now. What you need:</p>
<ul>
    <li>Card sleeves in 2 different colors with cardboard cards behind them (for example Magic or Pokemon cards).</li>
