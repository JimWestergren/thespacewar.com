...
foreach ( $nft_first_edition as $card_slug => $array ) {
    ...
    echo '<br>';
    if ( $array['token_id'] != '' ) {
        echo '<a href="https://opensea.io/item/ethereum/0x495f947276749ce646f68ac8c248420045cb7b5e/'.$array['token_id'].'" target="_blank">Buy this NFT</a>';
    } else {
        echo 'Buy this NFT';
    }
...
<p>
    NFT Creator: <code>0x7897aef045c31882eac1717fab943703d1dd40e7</code> (<a href='https://opensea.io/TheSpaceWar' target='_blank'>TheSpaceWar</a>)<br>
